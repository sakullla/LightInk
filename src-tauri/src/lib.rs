...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            managed::book_download_job_create,
            managed::book_download_job_get,
            managed::book_download_chapter_fetch,
            managed::book_download_finalize,
            managed::book_download_job_remove,
            remote::remote_open,
            remote::remote_info,
